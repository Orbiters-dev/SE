...
urlpatterns = [
    ...
    path("pipeline/creators/find-duplicates/", views.creator_find_duplicates, name="creator_find_duplicates"),
    path("pipeline/creators/merge/", views.creator_merge, name="creator_merge"),
